import{useEffect as v,useRef as g}from"react";import _ from"../../hooks/useMediaQuery.js";var d="22e22aec57326a333ff69315310ed2ec680e32380b8720607e4fce03bcc39304",u=`._wrapper_1ah6c_1 {
  position: relative;
  min-width: 20px;
  min-height: 20px;
  width: 100%;
...
`;(function(){if(globalThis.window&&!document.getElementById(d)){var e=document.createElement("style");e.id=d,e.textContent=u,document.head.appendChild(e)}})();var p={wrapper:"_wrapper_1ah6c_1",star:"_star_1ah6c_9",starSvgWrapper:"_starSvgWrapper_1ah6c_13"};import{getNumProps as m,getSingleChild as y}from"../../utils/framerControlProps.js";import{ControlType as S}from"framer";import{jsx as C}from"react/jsx-runtime";var w=`
