import{useEffect as v,useRef as g}from"react";import _ from"../../hooks/useMediaQuery.js";var m="6c62d415a9b4fa2ab19217f186c204f6c2198dcffddeaf5a8a8d2890141db7c3",u=`._wrapper_1ah6c_1 {
  position: relative;
  min-width: 20px;
  min-height: 20px;
  width: 100%;
...
`,x=(t,e,r=800)=>{let o=[{transform:"scale(0.5)"},{transform:"scale(1)"}],s=[{opacity:0},{opacity:1},{opacity:0}],n={duration:r,fill:"forwards"};e.animate(s,n),t.animate(o,n)},M=(t=5,e=15)=>r=>{let o=Math.floor(Math.max(Math.random()*e,t));r.style.width=`${o}px`,r.style.height=`${o}px`,r.style.top=`${Math.floor(Math.random()*70)}%`,r.style.left=`${Math.floor(Math.random()*100)}%`},b=()=>{let t=document.createElement("div"),e=document.createElement("div");return t.style.position="absolute",t.classList.add(p.star),e.classList.add(p.starSvgWrapper),e.innerHTML=w,t.appendChild(e),[t,e]},E=(t,{numOfStars:e=10,duration:r=800,minSize:o=10,maxSize:s=20})=>{let n=[],i=[];for(let a=0;a<e;a++){let c=a*(r+a*10),[l,f]=b();i.push(l),t?.appendChild(l);let h=M(o,s);n.push(setInterval(()=>{h(l),x(l,f,r)},c))}return()=>{n?.forEach(a=>clearInterval(a)),i.forEach(a=>{t?.removeChild(a)})}},I=({children:t,minSize:e=20,maxSize:r=25,numOfStars:o=5,duration:s=600,color:n="#debd05"})=>{let i=g(null),a=_("(prefers-reduced-motion: reduce)");return v(()=>{let c=!a&&E(i?.current,{numOfStars:o,duration:s,minSize:e,maxSize:r});return()=>{typeof c=="function"&&c()}},[a,e,r,o,s]),C("div",{className:p.wrapper,style:{"--path-fill":n},ref:i,children:t})},R={children:y(),minSize:d(10,!0,2),maxSize:d(10,!0,2),numOfStars:d(20,!1,5,{min:1,max:100}),duration:d(.5,!1,.1,{min:.1,max:2}),color:{type:S.Color,defaultValue:"#debd05"}};export{I as Sparkles,R as propsControls};
